...
ncd   = readPNG("raw/icons/NCD.png", native = FALSE)
cd    = readPNG("raw/icons/CD.png", native = FALSE)
wash  = readPNG("raw/icons/WASHOUT.png", native = FALSE)
decaf = readPNG("raw/icons/DECAF.png", native = FALSE)
caff  = readPNG("raw/icons/CAFF.png", native = FALSE)
```
...
```{r plot_cog, warning=FALSE, message = FALSE, fig.width = 10, fig.height = 14, out.height=14, out.width=10}
...
```{r fig_1_full_long, warning=FALSE, message=FALSE, fig.width=12, fig.height=14}
design_1long <- c("
ABB
ABB
CCC")
...
```{r, plot_MB, warning=FALSE, message = FALSE, fig.width = 16, fig.height = 10}
...
```{r, plot_met_fec, fig.width=12, fig.height=5, message=FALSE, warning=FALSE}
